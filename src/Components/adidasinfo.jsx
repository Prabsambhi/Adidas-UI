...
const adidasInfo = () => {
    return (
        <div className="flex space-x-10 py-16 px-16 bg-custom3 mt-20">
            <div className=" mb-8">
                <div className="pr-4">
                    <h2 className="text-2xl font-bold mb-4">STORIES, STYLES AND SPORTSWEAR AT ADIDAS, SINCE 1949</h2>
